...
public class Settings {
    ...
    private static final String ANDROID_APPLICATION_VERSION="android.application.version";
    ...
    private String AndroidApplicationVersion;
    ...
    private void loadSettings() {
        ...
        AndroidApplicationVersion = getPropertyOrThrowException(ANDROID_APPLICATION_VERSION);
    ...
    public String getApplicationVersion(){
        return AndroidApplicationVersion;
    }
